...
def generate_completion(user_input, function_descriptions, model_name=config.DEFAULT_MODEL):
...
def prepare_arguments_add_read_me(kpis, function_descriptions, language, model_name=config.DEFAULT_MODEL):
