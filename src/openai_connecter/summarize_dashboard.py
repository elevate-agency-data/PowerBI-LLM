    ...
    try:
        ...
        for page_data in extracted_json_by_page:
            ...
            prompt = (
                ...
                "2. **Visualizations**\n"
                "   - List all the visuals on the page, what they represent, and how users can interpret them. Do not include slicers, filters or date pickers.\n\n"
                "3. **Filtering**\n"
                ...
                "- Ensure that you do not forget any visual in the list of visualizations"
                "### Expected Output Format\n"
                "- Use headings and bullet points to organize the output.\n"
                "- Ensure clear and concise explanations for each section."
                f"- Ensure that all of the explanations and sections titles are in {language}"
                "### Example output:\n"
                "1. **Page Overview**\n"
                "   - This page, titled 'Sales Performance Overview', provides a comprehensive summary of regional sales performance across product categories and time periods. Its primary goal is to help sales managers monitor revenue trends, identify underperforming regions, and optimize sales strategies.\n\n"
                "2. **Visualizations**\n"
                "- Clustered Column Chart: Displays monthly sales revenue by region. Users can compare how different regions are performing over time."
                "- Pie Chart: Shows percentage contribution of each product category to total sales. Useful for spotting top-selling categories."
                "- Line Chart: Tracks overall sales trend over the past 12 months. Helps identify seasonal patterns or growth trajectory."
                "- Table with Conditional Formatting: Lists individual sales reps along with their sales figures and performance indicators (green/yellow/red based on targets)."
                "- KPI Cards: Highlight total revenue, average deal size, and year-over-year growth rate. These provide quick insights at a glance.\n\n"
                "3. **Filtering**\n"
                "- Date Slicer: Allows users to select specific time frames (e.g., quarters, months) for all visuals."
                "- Region Slicer: Filters data by selected geographical areas (e.g., North, South, East, West)."
                "- Product Category Filter: Lets users drill into specific product lines like Electronics, Apparel, or Home Goods."
                "- Sales Rep Dropdown: Enables focused analysis of individual salesperson performance.\n\n"
                "4. **Scenarios for Interpretation**\n"
                "- A manager wants to compare Q1 sales across regions: select Q1 in the date slicer and compare the clustered columns for each region."
                "- To identify best-performing products: use the product category filter and observe changes in the pie chart and KPIs."
                "- To evaluate an individual rep: choose a name from the Sales Rep dropdown and review the detailed table and KPIs."
                "- To detect seasonal dips: observe the line chart after selecting a 12-month range and look for recurring low points.\n\n"
            )
